...
if __name__ == '__main__':
    ...
    parser.add_argument('data', metavar='C:/Users/LENOVO/Documents/PyCharm/datasets/images/class_0000', help='path to dataset', required=False)
    parser.add_argument('--workers', default=4, type=int, help='number of data loading workers (default: 4)', required=False)
    parser.add_argument('--batch_size', default=580, type=int, required=False)
    parser.add_argument('--model_path', default='', type=str, help='path to model checkpoint (default: ImageNet-pretrained)', required=False)
    parser.add_argument('--n_out', default=1000, type=int, help='output dim of pre-trained model', required=False)
    parser.add_argument('--layer', default=1, type=int, choices=[1, 2, 6, 10, 14, 18], help='which layer?', required=False)
